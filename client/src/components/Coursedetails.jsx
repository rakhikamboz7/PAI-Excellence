...
//             <div
//               key={idx}
//               className="hover:shadow-lg transition-[50%] cursor-pointer bg-white border border-gray-300 rounded-[20px] hover:brightness-70 flex flex-col overflow-hidden"
//             >
//               <div className="p-6 flex-grow">
//                 <span className="inline-block text-xs text-[#6C6A74] bg-[#EBEAEF] px-3 py-1 rounded-full mb-4">
//                   {classLabel}
...
//                 src={course.img || "/placeholder.svg"}
//                 alt={course.title}
//                 className="w-full h-40 object-cover animate-float"
//               />
//               <div className="p-4">
//                 <div className="flex items-center text-sm text-[#6C6A74] mb-2 space-x-2">
//                   <FaUser className="text-[#FF6600]" />
...
//       {/* Contact Form & Testimonials omitted for brevity */}
...
//   const [modalCourse, setModalCourse] = useState(null);
//   const openModal = (c) => setModalCourse(c);
//   const closeModal = () => setModalCourse(null);
...
//   const watchTop = (i) => { window.location.href = practicalUrls[i] || practicalUrls[0]; };
//   const watchMore = (i) => { window.location.href = moreUrls[i] || moreUrls[0]; };

//   const [showAll, setShowAll] = useState(false);
//   const displayed = showAll ? moreCourses : moreCourses.slice(0, 6);
...
//       });
//       if (res.ok) {
//         setStatus("success"); setName(""); setEmail(""); setMsg("");
//       } else {
//         setStatus("error");
//       }
//     } catch {
...
//         style={{ backgroundImage: "url('/Hero.png')" }}
//       >
//         <div className="relative z-10 w-full lg:w-1/2 text-white">
//           <h2 className={`text-3xl lg:text-4xl font-bold mb-4 ${themeClasses.title}`}>
//             {t("courseDetail.heroTitle")}
//           </h2>
//           <p className="max-w-md text-lg opacity-90">{t("courseDetail.heroSubtitle")}</p>
...
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//           {topCourses.map((c, i) => (
//             <div key={i} className="bg-white border border-gray-300 rounded-[20px] overflow-hidden flex flex-col hover:shadow-lg transition">
//               <div className="p-6 flex-grow">
//                 <span className="inline-block text-xs text-[#6C6A74] bg-[#EBEAEF] px-3 py-1 rounded-full mb-4">
//                   {c.classLabel}
//                 </span>
//                 <h4 className={`text-lg font-bold mb-2 ${themeClasses.title}`}>{c.title}</h4>
//                 <p className="text-sm text-[#6C6A74]">{c.description}</p>
//               </div>
//               <button
//                 onClick={() => watchTop(i)}
//                 className={`mx-4 mb-4 py-3 ${themeClasses.button} text-white rounded-full font-semibold hover:brightness-90 transition`}
//               >
//                 {t("courseDetail.watchNow")} &rarr;
//               </button>
//             </div>
...
//                 <div className="flex items-center justify-between mb-4">
//                   <div className="flex items-center space-x-1">
//                     <FaStar className="text-[#FF6600]" /><span className="text-sm text-[#6C6A74]">{course.rating}</span>
//                   </div>
//                   <button
//                     onClick={(e) => { e.stopPropagation(); watchMore(idx); }}
//                     className={`bg-[#FF6600] text-white ${themeClasses.button} text-sm font-semibold rounded-full px-3 py-1 hover:brightness-90 transition`}
//                   >
//                     {t("courseDetail.watchNow")}
//                   </button>
...
//       {/* Modal, Contact, Testimonials omitted for brevity */}
...
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-2">
//                 <strong>{t("courseDetail.instructor")}</strong> {modalCourse.instructor}
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-2">
//                 <strong>{t("courseDetail.keyTakeaways")}</strong> {modalCourse.takeaways}
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-4">
//                 <strong>{t("courseDetail.whoJoined")}</strong> {modalCourse.joinees}
//               </p>
//               <button
...
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-2">
//                 <strong>Instructor:</strong> {modalCourse.instructor}
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-2">
//                 <strong>Key Takeaways:</strong> {modalCourse.takeaways}
//               </p>
//               <p className="text-sm text-[#6C6A74] mb-4">
//                 <strong>Who joined:</strong> {modalCourse.joinees}
//               </p>
//               <button
//                 onClick={() => handleWatchNowTop(0)}
//                 className={`w-full py-2 ${themeClasses.button} text-white font-semibold rounded-full hover:brightness-90 transition`}
...
//       {/* …modal, contact form, testimonials… */}

//       {/* Ken Burns animation (same as your cards) */}
//       <style jsx>{`
//         @keyframes kenburns {
//           0% { transform: scale(1) translate(0,0); }
//           50% { transform: scale(1.1) translate(-5%, -5%); }
